...
function searchWithTextIndex(body, _params, $search) {
  ...
  body.$.options.sort = Object.assign(body.$.options.sort || {}, {
    score: { $meta: "textScore" },
  });
  body.$.options.projection = Object.assign(body.$.options.projection || {}, {
    score: { $meta: "textScore" },
  });
}
...
function searchWithAtlasSearch(body, _params, $search) {
  ...
  // We don't want to use the sort from the $options
  body.$options.sort = undefined;
  delete body.$options.sort;
...
function searchWithRegex(body, _params, $search) {
  ...
  fields.forEach((field) => {
    ...
    if (!Number.isNaN(Number(_params.searchText))) {
